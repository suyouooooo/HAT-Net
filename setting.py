...
class CrossValidSetting:
    def __init__(self):
        ...
        #self.root = '/data/smb/syh/PycharmProjects/CGC-Net/data_baiyu/ExCRC/Cell_Graph/1792_Fuse_64_dim16/'#'/research/dept6/ynzhou/gcnn/data'
        ...
        self.root = '/data/smb/syh/PycharmProjects/CGC-Net/data_baiyu/ExCRC/Cell_Graph/1792_Avg_64/'
