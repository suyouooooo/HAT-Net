...
class GNN_Module(nn.Module):
    ...
    def forward(self, x, adj, mask=None):
        ...
        x0 = x
        x1 = self.bn(1,self.active1(self.gcn1(x0, adj, mask)))
        x2 = self.bn(2,self.active2(self.gcn2(x1, adj, mask)))
        x3 = self.bn(3,self.active3(self.gcn3(x2, adj, mask)))
...
class SoftPoolingGcnEncoder(nn.Module):
    ...
    def forward(self,  data):
        ...
        # diff_pool可微池化，是graph clustering的部分
